![Crossmint Banner](assets/crossmint_dark.png)
...
See the [samples README](samples/wallet_tx_send/README.md) for examples on how to create a wallet and send a transaction.
